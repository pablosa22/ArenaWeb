...
namespace AppArenaWeb.Models
{
    public class AgendaiModel
    {
        ...
        public List<AgendaiModel> ListaAgendai()        
        {
            ...
            else if (Id_Agendac == 0) 
            {
                sql = $"SELECT I.ID, I.ID_PRODUTO, P.DESCRICAO, I.QTDE, I.PUNIT, I.VLDESCONTO FROM AGENDAI I, PRODUTO P WHERE ID_PRODUTO = P.ID AND I.ID_AGENDAC = 0 ORDER BY P.DESCRICAO ASC";
            }
            DAL objDal = new DAL();
